...
import com.electro.cigma.entity.*;
import com.electro.cigma.service.account.UserAccountServices;
...
public class UserAccountController {
	...
	UserProfileImage handleGetProfileImage(@PathVariable int id) throws UserNotFound {
