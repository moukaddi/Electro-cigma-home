package com.electro.cigma.controller;
...
import com.electro.cigma.service.products.ProductServices;
...
import com.electro.cigma.dtos.AdminProductUpdate;
...
public class ProductsController {
    ...
    public ResponseEntity<?> handleAddAdvertisment(@PathVariable int id, @RequestParam("imageFile") MultipartFile multipartFile) throws IOException {
